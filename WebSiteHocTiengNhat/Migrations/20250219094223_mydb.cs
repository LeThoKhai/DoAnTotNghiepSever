        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VipActivatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotelScore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamQuestions_CategoryQuestions_CategoryQuestionId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CategoryQuestionId", "CategoryQuestionName", "IsGrammarVocabulary", "IsListening", "IsReading" },
                values: new object[,]
                {
                    { 1, "Đọc hiểu", false, false, true },
                    { 2, "Nghe hiểu", false, true, false },
                    { 3, "Ngữ pháp từ vựng", true, false, false }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamQuestions_CategoryQuestionId",
                table: "ExamQuestions",
